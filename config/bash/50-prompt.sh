# Blatently ripped and derived from "Cowboy" Ben Alman's dotfiles "awesome prompt"
# https://github.com/cowboy/dotfiles
#
# Copyright (c) 2018 Christopher Cook
...
alias __prompt_get_colors='__prompt_colors[9]=; local i; for i in ${!__prompt_colors[@]}; do local c$i="\[\e[1;${__prompt_colors[$i]}m\]"; done'
...
function __prompt_command() {
  ...
  if [[ "${#__prompt_vcs_info[@]}" != 0 ]]; then
    PS1="$PS1$c1[$c0$c4"
#    PS1="$PS1$c4${__prompt_vcs_info[0]}"
